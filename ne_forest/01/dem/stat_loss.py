...
def draw(dem, data, pathout):
    ...
    fig.savefig(pathout + '/' + 'loss_dem' + '.png', dpi=300, bbox_inches='tight')
    plt.close()
...
# python stat_loss.py -d /public/home/mfeng/jwang/forest/northeast/dem/Reproject/clip_dem.tif -t /public/home/mfeng/jwang/forest/northeast/out/loss_gain/clip/clip_loss.tif -o /public/home/mfeng/jwang/forest/northeast/out/dem
