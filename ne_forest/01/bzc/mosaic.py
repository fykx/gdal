...
def mosaic(datas, pathout, pathout_sh):
    ...
    f.write('gdal_merge.py -o {} -n -99.0 -a_nodata -99.0 '.format(pathout + '/' + 'std' + '.tif'))
    for i in datas:
        f.write('{} '.format(i))
    f.close()
    return
...
# python mosaic.py -i /public/home/mfeng/jwang/forest/northeast/out/bzc/1 -o /public/home/mfeng/jwang/forest/northeast/out/bzc/2 -os /public/home/mfeng/jwang/forest/northeast/code_tcc/inter_new/bzc